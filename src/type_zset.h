...
int rl_zincrby(rlite *db, const unsigned char *key, long keylen, double score, unsigned char *data, long datalen, double *newscore);
...
int rl_zrank(rlite *db, const unsigned char *key, long keylen, unsigned char *data, long datalen, long *rank);
...
int rl_zrevrank(rlite *db, const unsigned char *key, long keylen, unsigned char *data, long datalen, long *revrank);
...
int rl_zscore(rlite *db, const unsigned char *key, long keylen, unsigned char *data, long datalen, double *score);
